...
def SplitMNIST(
    ...
    *,
    ...
    return_datasets: Optional[bool] = False
):
    """
    ...
    mnist_train, mnist_val, mnist_test = _get_mnist_dataset(dataset_root, val_ratio=val_ratio)

    if return_datasets:
        return list_train_dataset, list_val_dataset, list_test_dataset
    else:
        if return_task_id:
            return nc_benchmark(
...
def RotatedMNIST(
    ...
    *,
    ...
    mnist_train, mnist_val, mnist_test = _get_mnist_dataset(dataset_root, val_ratio)
    ...
    for exp in range(n_experiences):
        ...
        list_val_dataset.append(rotated_val)
